...
import jabbyml.api.intern.DefaultApiClasses;
...
public class JabbyML {
  ...
  public JabbyML(String url, String apiKey, Connector connector) {
  ...
  public <T extends Api> T getApi(Class<T> apiInterface) {
    return (T)
        apiInstanceMap.computeIfAbsent(apiInterface, key -> instantiateApi(apiClassMap.get(key)));
  }
