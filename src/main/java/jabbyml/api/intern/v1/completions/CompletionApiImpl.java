...
class CompletionApiImpl extends BaseApi implements CompletionApi {

    CompletionApiImpl(ApiContext apiContext) {
        super(apiContext);
    }

    @Override
    public Future<CompletionResponse> find(CompletionRequest completionRequest) {
        return post(
                "/v1/completions",
                completionRequest,
